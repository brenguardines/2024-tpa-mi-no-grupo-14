    ...
    public static <T> T instanceOf(Class<T> componentClass) {
        ...
        if (!instances.containsKey(componentName)) {
            if(componentName.equals(PersonaHumanaController.class.getName())) {
                ...
                AuthController instance = new AuthController(instanceOf(UsuarioRepository.class), instanceOf(PersonaHumanaRepository.class), instanceOf(PersonaJuridicaRepository.class));
                instances.put(componentName, instance);
            }
