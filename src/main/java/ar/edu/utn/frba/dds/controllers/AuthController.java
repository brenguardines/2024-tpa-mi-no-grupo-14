...
public class AuthController{
    ...
    public AuthController(UsuarioRepository repoUsuarios, PersonaHumanaRepository repoPersonaHumana, PersonaJuridicaRepository repoPersonaJuridica) {
            ...
            if (usuarioLogueado.contraseniaCorrecta(contrasenia)) {
                ...
                switch (usuarioLogueado.getRol()) {
                    ...
                    case TECNICO:
                        ...
                        //context.sessionAttribute("idColaboradorHumano", personaHumana.getId().toString());
                        // Buscar la PersonaJuridica asociada al usuario
                        List<Tecnico> tecnicos = tecnicoRepository.buscarElementosPorUsuario(usuarioLogueado);
                        if (!tecnicos.isEmpty()) {
